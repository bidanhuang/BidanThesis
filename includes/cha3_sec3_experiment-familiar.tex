...
\begin{figure}
  \centering
   \subfloat[  {Best grasp found}]  {\includegraphics[width=3.3cm]{./fig_cha3/ash_near1.pdf}}
   %\hspace{0.3cm}
   \subfloat[  {Neighbor grasp of a}] {\includegraphics[width=3.3cm]{./fig_cha3/ash_near2.pdf}}
   %\hspace{0.3cm}
   \subfloat[  {Best grasp found}] {\includegraphics[width=3.3cm]{./fig_cha3/joy_near1.pdf}}
   %\hspace{0.3cm}
   \subfloat[  {Neighbor grasp of c}] {\includegraphics[width=3.3cm]{./fig_cha3/joy_near2.pdf}}
