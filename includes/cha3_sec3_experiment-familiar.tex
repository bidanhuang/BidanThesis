...
\begin{figure}
  \centering
   \subfloat[\scriptsize{Best grasp found}]  {\includegraphics[width=3cm]{./fig_cha3/ash_near1.pdf}}
   \subfloat[\scriptsize{Neighbor grasp of (a)}] {\includegraphics[width=3cm]{./fig_cha3/ash_near2.pdf}}
   \subfloat[\scriptsize{Best grasp found}] {\includegraphics[width=3cm]{./fig_cha3/joy_near1.pdf}}
   \subfloat[\scriptsize{Neighbor grasp of (c)}] {\includegraphics[width=3cm]{./fig_cha3/joy_near2.pdf}}
...
\begin{figure*}
  \centering
    ...
    \subfloat[\scriptsize{Initial pose 1}]  {\includegraphics[width=4cm]{./fig_cha3/bar_i_1.pdf}}
    \subfloat[\scriptsize{Initial pose 2}] { \includegraphics[width=4cm]{./fig_cha3/bar_i_2.pdf}}
    \subfloat[\scriptsize{Initial pose 3}] { \includegraphics[width=4cm]{./fig_cha3/bar_i_3.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Final grasp 1}] {\includegraphics[width=4cm]{./fig_cha3/bar_f_1.pdf}}
    \subfloat[\scriptsize{Final grasp 2}]  {\includegraphics[width=4cm]{./fig_cha3/bar_f_2.pdf}}
    \subfloat[\scriptsize{Final grasp 3}]  {\includegraphics[width=4cm]{./fig_cha3/bar_f_3.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Initial pose 4}]  {\includegraphics[width=4cm]{./fig_cha3/shoe_1i.pdf}}
    \subfloat[\scriptsize{Initial pose 5}] {\includegraphics[width=4cm]{./fig_cha3/shoe_2i.pdf}}
    \subfloat[\scriptsize{Initial pose 6}]  {\includegraphics[width=4cm]{./fig_cha3/shoe_3i.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Final grasp 4}] {\includegraphics[width=4cm]{./fig_cha3/shoe_1f.pdf}}
    \subfloat[\scriptsize{Final grasp 5}] {\includegraphics[width=4cm]{./fig_cha3/shoe_2f.pdf}}
    \subfloat[\scriptsize{Final grasp 6}]  {\includegraphics[width=4cm]{./fig_cha3/shoe_3f.pdf}}
...
\begin{figure*}
  \centering
    \subfloat[\scriptsize{Initial pose 7}]  {\includegraphics[width=4cm]{./fig_cha3/joy_2_i.pdf}}
    \subfloat[\scriptsize{Initial pose 8}] {\includegraphics[width=4cm]{./fig_cha3/joy_3_i.pdf}}
    \subfloat[\scriptsize{Initial pose 9}] {\includegraphics[width=4cm]{./fig_cha3/joy_5_i.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Final grasp 7}] {\includegraphics[width=4cm]{./fig_cha3/joy_2_f.pdf}}
    \subfloat[\scriptsize{Final grasp 8}]  {\includegraphics[width=4cm]{./fig_cha3/joy_3_f.pdf}}
    \subfloat[\scriptsize{Final grasp 9}]  {\includegraphics[width=4cm]{./fig_cha3/joy_5_f.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Initial pose 10}]  {\includegraphics[width=4cm]{./fig_cha3/plane_2i.pdf}}
    \subfloat[\scriptsize{Initial pose 11}] {\includegraphics[width=4cm]{./fig_cha3/plane_3i.pdf}}
    \subfloat[\scriptsize{Initial pose 12}] {\includegraphics[width=4cm]{./fig_cha3/plane_1i.pdf}}
    \vspace{0.3cm}
    \subfloat[\scriptsize{Final grasp 10}] {\includegraphics[width=4cm]{./fig_cha3/plane_2f.pdf}}
    \subfloat[\scriptsize{Final grasp 11}]  {\includegraphics[width=4cm]{./fig_cha3/plane_3f.pdf}}
    \subfloat[\scriptsize{Final grasp 12}]  {\includegraphics[width=4cm]{./fig_cha3/plane_1f.pdf}}
