...
\begin{figure*}
  \centering
    \subfloat[  {Optitrack markers attaching to a cap}] {\includegraphics[height=3cm]{./fig_cha4/marker2.jpg}}
    \subfloat[  {Force torque sensor}] {\includegraphics[height=3cm]{./fig_cha4/Nano25-E.jpg}}
    \subfloat[  {Texscan tactile sensors mounting to a glove}] {\includegraphics[height=3cm]{./fig_cha4/texscan2.jpg}}
...
\begin{figure}
  \centering
      \subfloat[  {}]{\includegraphics[width=12cm]{./fig_cha4/control_1_2.pdf}}
      \vspace{0.5cm}
      \subfloat[  {}]{\includegraphics[width=12cm]{./fig_cha4/control_3_2.pdf}}
      \caption{   {Control flow diagram of forward-inverse
