...
%\vspace{-0.3cm}
\centering
    \subfloat[\scriptsize{Initial pose 1}]  {\includegraphics[width=1.05in]{./fig_cha3/8_i.jpg}}
    %\hspace{-0.01in}
    \subfloat[\scriptsize{Initial pose 2}] {\includegraphics[width=1.05in]{./fig_cha3/1_i.jpg}}
    %\hspace{0.01in}
    \subfloat[\scriptsize{Initial pose 3}] {\includegraphics[width=1.05in]{./fig_cha3/5_i.jpg}}
    %\vspace{0.05in}

    \subfloat[\scriptsize{Final grasp 1}] {\includegraphics[width=1.05in]{./fig_cha3/8_f.jpg}}
    \hspace{0.005in}
    \subfloat[\scriptsize{Final grasp 2}] {\includegraphics[width=1.05in]{./fig_cha3/1_f.jpg}}
    \hspace{0.005in}
    \subfloat[\scriptsize{Final grasp 3}] {\includegraphics[width=1.05in]{./fig_cha3/5_f.jpg}}

    \subfloat[\scriptsize{3D projections}] {\includegraphics[width=1.8in]{./fig_cha3/object_cylball_i_f_arrow.jpg}}
    \hspace{0.005in}
    \subfloat[\scriptsize{2D contour projections}] {\includegraphics[width=1.4in]{./fig_cha3/contour_Z_cylball_i_f_arrow2.jpg}}
...
\begin{figure}
\centering
    \subfloat[\scriptsize{}]  {\includegraphics[width=5cm]{./fig_cha3/spr.jpg}}
    \hspace{1cm}
    \subfloat[\scriptsize{}] {\includegraphics[width=5cm]{./fig_cha3/box123.jpg}}
%    \hspace{0.01in}
...
\begin{figure}
\centering
    \subfloat[\scriptsize{Initial pose 1}]  {\includegraphics[height= 4cm]{./fig_cha3/spr_3_i.jpg}}
    \hspace{1cm}
    \subfloat[\scriptsize{Initial pose 2}] {\includegraphics[height= 4cm]{./fig_cha3/spr_4_i.jpg}}
    \hspace{1cm}
    \subfloat[\scriptsize{Initial pose 3}] {\includegraphics[height= 4cm]{./fig_cha3/spr_6_i.jpg}}

    %\vspace{0.05in}
    \subfloat[\scriptsize{Final grasp 1}] {\includegraphics[width=4cm]{./fig_cha3/spr_3_f.jpg}}
    \hspace{1cm}
    \subfloat[\scriptsize{Final grasp 2}] {\includegraphics[height=4cm]{./fig_cha3/spr_4_f.jpg}}
    \hspace{1cm}
    \subfloat[\scriptsize{Final grasp 3}] {\includegraphics[width=4cm]{./fig_cha3/spr_6_f.jpg}}
...
\begin{figure}
\centering
    \subfloat[\scriptsize{}]  {\includegraphics[width=5cm]{./fig_cha3/bedside.jpg}}
    \hspace{0.07in}
    \subfloat[\scriptsize{}] {\includegraphics[width=5cm]{./fig_cha3/bedside_box.jpg}}
%    \hspace{0.01in}
...
\begin{figure}
\centering
    \subfloat[\scriptsize{Initial pose 1}]  {\includegraphics[width=4cm]{./fig_cha3/bed_6_i.jpg}}
    \hspace{0.2cm}
    \subfloat[\scriptsize{Initial pose 2}] {\includegraphics[width=4cm]{./fig_cha3/bed_3_i.jpg}}
    \hspace{0.7cm}
    \subfloat[\scriptsize{Initial pose 3}] {\includegraphics[width=4cm]{./fig_cha3/bed_5_i.jpg}}
    %\vspace{0.05in}

    \subfloat[\scriptsize{Final grasp 1}] {\includegraphics[width=4cm]{./fig_cha3/bed_6_f.jpg}}
    \hspace{0.005in}
    \subfloat[\scriptsize{Final grasp 2}] {\includegraphics[width=4cm]{./fig_cha3/bed_3_f.jpg}}
    \hspace{0.005in}
    \subfloat[\scriptsize{Final grasp 3}] {\includegraphics[width=4cm]{./fig_cha3/bed_5_f.jpg}}
